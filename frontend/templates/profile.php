...
$foto = '../src/css/240_F_553796090_XHrE6R9jwmBJUMo9HKl41hyHJ5gqt9oz.jpg'; // Si tienes foto, ajusta aquí
?>
<!DOCTYPE html>
<html lang="es">
<head>
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <?php if ($user_role_name === 'admin'): // Funciones solo para administradores ?>
                        ...
                        <li><a href="../templates/profile.php" class="active">Mi Perfil</a></li>
                    <?php endif; ?>
